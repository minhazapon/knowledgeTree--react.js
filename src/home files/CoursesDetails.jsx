...
const CoursesDetails = ({query}) => {


    const {image, name, title, price} = query

    
    return (
        <div>

            <article class="  relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 w-[300px] h-[300px] mx-auto mt-24">
